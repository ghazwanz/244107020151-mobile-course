# Portofolio Perkuliahan Pemrograman Mobile (Flutter)

Repositori ini mendokumentasikan progres pembelajaran, tugas praktikum, dan proyek akhir selama satu semester (16 minggu) pada mata kuliah Pemrograman Mobile.
...
- **Nama**: Ghazwan Ababil
- **NIM**: 244107020151
- **Repositori**: [github.com/ghazwanz/244107020151-mobile-course](https://github.com/ghazwanz/244107020151-mobile-course)
- **Ringkasan Portofolio**: [portfolio-summary.md](./portfolio-summary.md)

---

## Stack Teknologi Utama

Pengembangan aplikasi mobile pada portofolio ini memanfaatkan ekosistem resmi:

- **Framework & SDK**: Flutter (Dart SDK ^3.x)
- **Target OS**: Android (Dengan Android SDK)
- **Version Control**: Git & GitHub
- **IDE**: VS Code & Android Studio

---

## Indeks Navigasi 16 Minggu Perkuliahan
...
| **11** | Performance Optimization & Profiling           | [11-week-11-performance-optimization](./11-week-11-performance-optimization/)                                         |        |
| **12** | Testing & Quality Assurance                    | [12-week-12-testing-quality-assurance](./12-week-12-testing-quality-assurance/)                                       |        |
| **13** | CI/CD Automation with GitHub Actions           | [13-week-13-ci-cd-automation](./13-week-13-ci-cd-automation/)                                                         |        |
| **14** | Deployment & Production Monitoring             | [14-week-14-deployment-monitoring](./14-week-14-deployment-monitoring/)                                               |        |
| **15** | Secure Mobile Development                      | [15-week-15-secure-mobile-development](./15-week-15-secure-mobile-development/)                                       |        |
| **16** | Final Project Expo & Showcase                  | [16-week-16-final-project-expo](./16-week-16-final-project-expo/)                                                     |        |

---

## Catatan & Jurnal Belajar

Seluruh refleksi berkala dan catatan teknis tersimpan di direktori [`notes/`](./notes/), mencakup [Refleksi Mingguan](./notes/reflections/), [Jurnal Belajar](./notes/learning-journal/), dan [Sumber Daya](./notes/resources/).
